...
__all__ = ['initString', 'assembleSystem', 'assembleSystem1',
           'jacobianAssembleSystem', 'jacobianAssembleSystem1']
...
def dynamicLagrangian(q_n_k, q_np1_k, q_n_kp1, q_np1_kp1,
    ...
    """
    T = 0.5 * (kineticEnergy(q_n_k, q_n_kp1, M, time_step)
               + kineticEnergy(q_np1_k, q_np1_kp1, M, time_step))
    V_int = 0.5 * (internalPotentialEnergy(q_n_k, q_np1_k, C, step)
                   + internalPotentialEnergy(q_n_kp1, q_np1_kp1,
                                             C, step))
    V_ext = 0.25 * (externalPotentialEnergy(q_n_k, step, M, g_)
                    + externalPotentialEnergy(q_n_kp1, step, M, g_)
                    + externalPotentialEnergy(q_np1_k, step, M, g_)
                    + externalPotentialEnergy(q_np1_kp1, step, M, g_))
...
def D1dynamicLagrangian(q_n_k, q_np1_k, q_n_kp1, q_np1_kp1,
    ...
    """
    return jacrev(dynamicLagrangian,
...
def assembleSystem(x_kp1, x_k, x_km1, string, time_step, g_):
    ...
    D1dynamicLagrangianString = vmap(D1dynamicLagrangian,
                                     in_axes=[0, 0, 0, 0, None, None,
                                              None, None, None])
    D2dynamicLagrangianString = vmap(D2dynamicLagrangian,
                                     in_axes=[0, 0, 0, 0, None, None,
                                              None, None, None])
    D3dynamicLagrangianString = vmap(D3dynamicLagrangian,
                                     in_axes=[0, 0, 0, 0, None, None,
                                              None, None, None])
    D4dynamicLagrangianString = vmap(D4dynamicLagrangian,
                                     in_axes=[0, 0, 0, 0, None, None,
                                              None, None, None])
...
def jacobianAssembleSystem(q_kp1, q_k, q_km1, string, time_step, g_):
    ...
    """
    return jacfwd(assembleSystem, 0)(q_kp1, q_k, q_km1,
                                     string, time_step, g_)
