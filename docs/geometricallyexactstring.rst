...
.. autofunction:: GeometricallyExactString.internalPotentialEnergy
...
.. autofunction:: GeometricallyExactString.externalPotentialEnergy

The Lagranian density is thus :math:`L(r, v, \nu) = T(v) - U_{int}(\nu) - U_{ext}(r)`. Only fixed-free boundary conditions in space are considered.

.. autofunction:: GeometricallyExactString.dynamicLagrangian
